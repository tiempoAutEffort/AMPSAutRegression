...
WebUI.waitForElementPresent(findTestObject('UI/Client/Client Services/ForgotPassword/a_ForgotPassword'), 5)

WebUI.waitForElementVisible(findTestObject('UI/Client/Client Services/ForgotPassword/a_ForgotPassword'), 5)
