...
WebUI.click(findTestObject('UI/Employee/Report Manager/Schedule Reports/table_First Row_Delete Button'))

WebUI.delay(2)

WebUI.click(findTestObject('UI/Employee/Report Manager/Schedule Reports/button_Delete Warning_Yes Button'))

WebUI.delay(2)

not_run: WebUI.click(findTestObject('UI/Employee/Report Manager/Schedule Reports/button_Delete Warning_Yes Button'))
