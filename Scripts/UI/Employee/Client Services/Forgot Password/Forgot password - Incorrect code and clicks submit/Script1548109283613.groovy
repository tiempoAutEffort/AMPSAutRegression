...
WebUI.sendKeys(findTestObject('UI/Employee/Client Services/ForgotPassword/input_ForgotPassword_Code TextBox'), 'test')
...
WebUI.verifyElementPresent(findTestObject('UI/Employee/Client Services/ForgotPassword/input_ForgotPassword_Code TextBox'), 
    5)

WebUI.verifyElementPresent(findTestObject('UI/Employee/Client Services/ForgotPassword/input_ForgotPassword_Submit Button'), 
    5)
