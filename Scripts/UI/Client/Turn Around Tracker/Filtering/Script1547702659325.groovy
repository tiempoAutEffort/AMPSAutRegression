...
//Verify TAT chart area is displayed
WebUI.waitForElementPresent(findTestObject('UI/Client/Turn Around Tracker/div_tatChart'), 5)
WebUI.verifyElementVisible(findTestObject('UI/Client/Turn Around Tracker/div_tatChart'))

//Select Group Filter
WebUI.waitForElementClickable(findTestObject('UI/Client/Turn Around Tracker/select_groupFilter'), 5)
WebUI.click(findTestObject('UI/Client/Turn Around Tracker/select_groupFilter'))
WebUI.delay(2)
WebUI.click(findTestObject('UI/Client/Turn Around Tracker/option_sevenKeystone'))
WebUI.delay(2)

//Verify TAT chart area is displayed after applying a filter
WebUI.waitForElementPresent(findTestObject('UI/Client/Turn Around Tracker/div_tatChart'), 5)
WebUI.verifyElementVisible(findTestObject('UI/Client/Turn Around Tracker/div_tatChart'))
WebUI.delay(3)
