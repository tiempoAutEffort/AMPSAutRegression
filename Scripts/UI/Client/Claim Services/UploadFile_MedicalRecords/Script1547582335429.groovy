...
WebUI.waitForElementClickable(findTestObject('UI/Client/Claim Services/span_secondClaim'), 5)
WebUI.click(findTestObject('UI/Client/Claim Services/span_secondClaim'))
WebUI.waitForPageLoad(5)
...
//Upload file
WebUI.waitForElementPresent(findTestObject('UI/Client/Claim Services/input_NewFile'), 5)
WebUI.uploadFile(findTestObject('UI/Client/Claim Services/input_NewFile'), UPFILE)
WebUI.delay(3)

//Select file name dropdown and select "Medical Records"
...
WebUI.delay(2)
WebUI.click(findTestObject('UI/Client/Claim Services/option_providerSignOff'))
WebUI.delay(2)
