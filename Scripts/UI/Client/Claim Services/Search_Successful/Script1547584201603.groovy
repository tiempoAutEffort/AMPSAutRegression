...
CLAIM = WebUI.getText(findTestObject('UI/Client/Claim Services/span_firstClaim'))

//Enter valid Claim id
WebUI.waitForElementVisible(findTestObject('UI/Client/Claim Services/input_ampsClaimID'), 5)
WebUI.setText(findTestObject('UI/Client/Claim Services/input_ampsClaimID'), CLAIM)
WebUI.delay(2)
...
//Verify that a search has been performed
//Only specific Claim should be displayed in search results and no pagination button "2" should be displayed
WebUI.verifyElementPresent(findTestObject('UI/Client/Claim Services/span_firstClaim'), 5)
WebUI.verifyElementNotPresent(findTestObject('UI/Client/Claim Services/span_secondClaim'), 5)
WebUI.verifyElementNotPresent(findTestObject('UI/Client/Claim Services/li_pageTwo'), 5)
WebUI.waitForElementVisible(findTestObject('UI/Client/Claim Services/li_nextPage'), 5)
WebUI.verifyElementVisible(findTestObject('UI/Client/Claim Services/li_nextPage'))
WebUI.delay(3)
