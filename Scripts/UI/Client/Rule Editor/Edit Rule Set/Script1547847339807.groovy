...
//**** Edit Rule Set - Edit Name , Valid From , Valid To 
...
//Enter new Rule Set data - Name , Valid From , Valid To
...
WebUI.click(findTestObject('UI/Client/Rule Editor/Edit Rule Set/span_clearValidFrom'))
WebUI.delay(1)
...
//Verify edited Rule Set Name is displayed
...
//**** Edit Rule set by adding another Rule ****//
...
//Verify first and second Rule are displayed
WebUI.verifyElementPresent(findTestObject('UI/Client/Rule Editor/Create Rule Set/span_firstRule'), 5)
WebUI.verifyElementPresent(findTestObject('UI/Client/Rule Editor/Create Rule Set/span_secondRule'), 5)
WebUI.delay(2)
